...
@section('mainstyle')
<link rel="stylesheet" type="text/css" href="{{ URL::asset('css/shop_styles.css') }}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('css/shop_responsive.css') }}">
...
<div class="home">
    <div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{ URL::asset('images/shop_background.jpg') }}"></div>
