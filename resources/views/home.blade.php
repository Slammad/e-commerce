					...
					<div class="featured">
                        ...
                        @foreach($products as $product)
									<div class="featured_slider_item">
										...
										<div class="product_image d-flex flex-column align-items-center justify-content-center"><a href="{{route('product.show',$product->slug)}}"><img src="images/featured_8.png" alt=""></a></div>
											<div class="product_content">
                                            <div class="product_price">{{$product->price}}</div>
                                            <div class="product_name"><div><a href="product.html">{{$product->original_price}}</a></div></div>
